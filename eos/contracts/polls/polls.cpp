...
class polls : public contract {
    using contract::contract;

public:
    polls (account_name self) : contract(self), _pollresults(_self, _self){}
    ...
    typedef singleton<N(polls), N(config), N(polls), config> configs;
...
EOSIO_ABI( polls, (setapp)(addpoll)(deletepoll))